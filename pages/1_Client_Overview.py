...
# ═══════════════════════════════════════════════════════════════
# MODEL FITTING (runs outside columns — shows spinners)
# ═══════════════════════════════════════════════════════════════
...
with _c6:
    context_block(
        ...
        "These are directional — not precise. Use them for relative "
        "comparison between channels.\n\n"
        "For high-stakes budget changes, validate with controlled "
        "geo-lift or holdout experiments."
    )
