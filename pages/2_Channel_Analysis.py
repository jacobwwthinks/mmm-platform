...
fig_roas.add_trace(go.Bar(
    ...
    marker_color=px.colors.qualitative.Set2[:len(roas_df)],
    text=[f"{r:.2f}x" for r in roas_df["roas_mean"]],
    textposition="outside",
))

fig_roas.add_hline(y=1.0, line_dash="dash", line_color="red", annotation_text="Breakeven (1.0x)")
...
fig_sat.add_trace(go.Scatter(
    ...
    y=[current_sat],
    mode="markers+text",
    marker=dict(size=15, color="#E84855"),
